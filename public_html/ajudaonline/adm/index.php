...
<html lang="pt-br">
 ...
 <body>
  ...
  <div class="content">
    <!-- inicio sidebar -->
    <div class="sidebar">
      <a class="sidebar-nav active" href="index.php"><i class="icon fa-solid fa-home"></i><span>Central</span></a>
      <a class="sidebar-nav" href="listar.php"><i class="icon fa-solid fa-users"></i><span>Listar</span></a>
      <a class="sidebar-nav" href="login.php"><i class="icon fa-solid fa-arrow-right-from-bracket"></i><span>Sair</span></a>
    </div>
    <!-- fim sidebar -->
